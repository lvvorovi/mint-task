...
class SourceCurrencySupportedTransactionPreValidationRuleTest {

    @InjectMocks
    SourceCurrencySupportedTransactionPreValidationRule victim;
    ...
    void validate_whenDoesNotContain_thenThrowCurrencyNotSupportedException() {
        ...
        when(transactionRequestMock.sourceCurrency()).thenReturn("EUR");
